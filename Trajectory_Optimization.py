#
# GELATO2-CasADi: Generic Launch Trajectory Optimizer
#
# CasADi rewrite of GELATO2.  Same input JSON, same output CSV.
# All Jacobians are computed automatically via CasADi AD.
#
# Usage:
#   cd GELATO2_casadi
